                  ...
                  <div class="layer_2" style="max-width: 600px; display: inline-block; vertical-align: top; width: 100%;">
                    <table border="0" cellspacing="0" cellpadding="0" class="edcontent" style="border-collapse: collapse;width:100%">
                      ...
                      <!-- Put  logo url down here -->
                        <tr>
                          <td valign="top" class="edimg" style="padding: 20px; box-sizing: border-box; text-align: center;"><img src="images/bg/web.png" alt="Image" style="border-width: 0px; border-style: none; max-width: 380px; width: 100%;" width="380">
                          </td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td valign="top" class="edtext" style="padding: 32px; color: #3d3d3d; font-size: 14px; text-align: left; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;">
                            <p class="style1 text-center" style="line-height: 1.25em; color: #090116; font-family: &quot;Arial Black&quot;, Gadget, sans-serif; text-align: center; margin: 0px; padding: 0px; font-size: 32px;"><strong>New Contact Form Submission</strong></p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
